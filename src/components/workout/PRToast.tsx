...
export default function PRToast({ exerciseName, metric, previousValue, newValue, direction, unitSystem, onDismiss }: PRToastProps) {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-[110] flex justify-center pointer-events-none">
      <div className="animate-pr-toast pointer-events-auto flex max-w-[90%] items-center gap-3 rounded-lg bg-primary px-5 py-3 text-primary-foreground shadow-md">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0">
          <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
        </svg>
        <div>
          <p className="text-sm font-semibold">New PR!</p>
